...
#
#
#cookie lib to http.cookiejar
#import sys, time, random, re, os, cookielib
import sys, time, random, re, os, http.cookiejar
...
def baixaCVLattes(id_lattes, debug=True):
    ...
    if debug:
        print (f'[AVISO] Nao é possível obter o CV Lattes: {id_lattes}')
        print ('[AVISO] Certifique-se que o CV existe.')
    
    raise Exception("Nao foi possivel baixar o CV Lattes em 10 tentativas")
