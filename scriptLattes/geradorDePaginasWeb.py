...
class GeradorDePaginasWeb:
    ...
    def gerarPaginaPrincipal(self):
        nomeGrupo = self.grupo.obterParametro('global-nome_do_grupo')#.decode(encoding="utf8")
        ...
        if self.grupo.obterParametro('relatorio-incluir_metricas'):
            s += '| <a href=metricas' + self.extensaoPagina + '><b>Métricas</b></a> '#.decode("utf8")

        s += ' ] </center><br></div>'
        s += '<h3 id="producaoBibliografica">Produção bibliográfica</h3> <ul>'#.decode("utf8")

        if self.nPB0 > 0:
            s += '<li> <a href="PB0-0' + self.extensaoPagina + '">Artigos completos publicados em periódicos</a> '+ '(' + str(self.nPB0) + ')'#.decode(
                #"utf8") + '(' + str(self.nPB0) + ')'
        if self.nPB1 > 0:
            s += '<li> <a href="PB1-0' + self.extensaoPagina + '">Livros publicados/organizados ou edições</a> ' + '(' + str(self.nPB1) + ')'#.decode(
                #"utf8") + '(' + str(self.nPB1) + ')'
        if self.nPB2 > 0:
            s += '<li> <a href="PB2-0' + self.extensaoPagina + '">Capítulos de livros publicados </a> ' + '(' + str(self.nPB2) + ')'#.decode(
                #"utf8") + '(' + str(self.nPB2) + ')'
        if self.nPB3 > 0:
            s += '<li> <a href="PB3-0' + self.extensaoPagina + '">Textos em jornais de notícias/revistas </a> ' + '(' + str(self.nPB3) + ')'#.decode(
                #"utf8") + '(' + str(self.nPB3) + ')'
        if self.nPB4 > 0:
            s += '<li> <a href="PB4-0' + self.extensaoPagina + '">Trabalhos completos publicados em anais de congressos </a> '+ '(' + str(self.nPB4) + ')'#.decode(
                #"utf8") + '(' + str(self.nPB4) + ')'
        if self.nPB5 > 0:
            s += '<li> <a href="PB5-0' + self.extensaoPagina + '">Resumos expandidos publicados em anais de congressos </a> '+ '(' + str(self.nPB5) + ')'#.decode(
                #"utf8") + '(' + str(self.nPB5) + ')'
        if self.nPB6 > 0:
            s += '<li> <a href="PB6-0' + self.extensaoPagina + '">Resumos publicados em anais de congressos </a> ' + '(' + str(self.nPB6) + ')'#.decode(
                #"utf8") + '(' + str(self.nPB6) + ')'
        if self.nPB7 > 0:
            s += '<li> <a href="PB7-0' + self.extensaoPagina + '">Artigos aceitos para publicação </a> ' #.decode(
                #"utf8") + '(' + str(self.nPB7) + ')'
        if self.nPB8 > 0:
            s += '<li> <a href="PB8-0' + self.extensaoPagina + '">Apresentações de trabalho </a> '+ '(' + str(self.nPB8) + ')'#.decode(
                #"utf8") + '(' + str(self.nPB8) + ')'
        if self.nPB9 > 0:
            s += '<li> <a href="PB9-0' + self.extensaoPagina + '">Demais tipos de produção bibliográfica </a> ' + '(' + str(self.nPB9) + ')'#.decode(
                #"utf8") + '(' + str(self.nPB9) + ')'
        if self.nPB > 0:
            s += '<li> <a href="PB-0' + self.extensaoPagina + '">Total de produção bibliográfica</a> ' + '(' + str(self.nPB) + ')'#.decode(
                #"utf8") + '(' + str(self.nPB) + ')'
        else:
        ...
        if self.nPT0 > 0:
            s += '<li> <a href="PT0-0' + self.extensaoPagina + '">Programas de computador com registro de patente</a> '+ '(' + str(self.nPT0) + ')'#.decode(
                #"utf8") + '(' + str(self.nPT0) + ')'
        if self.nPT1 > 0:
            s += '<li> <a href="PT1-0' + self.extensaoPagina + '">Programas de computador sem registro de patente</a> '+ '(' + str(self.nPT1) + ')'#.decode(
                #"utf8") + '(' + str(self.nPT1) + ')'
        if self.nPT2 > 0:
            s += '<li> <a href="PT2-0' + self.extensaoPagina + '">Produtos tecnológicos</a> '+ '(' + str(self.nPT2) + ')'#.decode(
                #"utf8") + '(' + str(self.nPT2) + ')'
        if self.nPT3 > 0:
            s += '<li> <a href="PT3-0' + self.extensaoPagina + '">Processos ou técnicas</a> '+ '(' + str(self.nPT3) + ')'#.decode(
                #"utf8") + '(' + str(self.nPT3) + ')'
        if self.nPT4 > 0:
            s += '<li> <a href="PT4-0' + self.extensaoPagina + '">Trabalhos técnicos</a> '+ '(' + str(
                self.nPT4) + ')'#.decode("utf8") + '(' + str(
                #self.nPT4) + ')'
        if self.nPT5 > 0:
            s += '<li> <a href="PT5-0' + self.extensaoPagina + '">Demais tipos de produção técnica</a> '+ '(' + str(self.nPT5) + ')'#.decode(
                #"utf8") + '(' + str(self.nPT5) + ')'
        if self.nPT > 0:
            s += '<li> <a href="PT-0' + self.extensaoPagina + '">Total de produção técnica</a> '+ '(' + str(self.nPT) + ')'#.decode(
                #"utf8") + '(' + str(self.nPT) + ')'
        else:
            s += '<i>Nenhum item achado nos currículos Lattes</i>'#.decode("utf8")
        ...
        if self.nPA > 0:
            s += '<li> <a href="PA-0' + self.extensaoPagina + '">Total de produção artística</a> ' + '(' + str(self.nPA) + ')'#.decode(
                #"utf8") + '(' + str(self.nPA) + ')'
        else:
            s += '<i>Nenhum item achado nos currículos Lattes</i>'#.decode("utf8")
        ...
        if self.grupo.obterParametro('relatorio-mostrar_orientacoes'):
            ...
            s += '<ul>'
            if self.nOA0 > 0:
                s += '<li> <a href="OA0-0' + self.extensaoPagina + '">Supervisão de pós-doutorado</a> ' + '(' + str(self.nOA0) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOA0) + ')'
            if self.nOA1 > 0:
                s += '<li> <a href="OA1-0' + self.extensaoPagina + '">Tese de doutorado</a> '+ '(' + str(self.nOA1) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOA1) + ')'
            if self.nOA2 > 0:
                s += '<li> <a href="OA2-0' + self.extensaoPagina + '">Dissertação de mestrado</a> '+ '(' + str(self.nOA2) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOA2) + ')'
            if self.nOA3 > 0:
                s += '<li> <a href="OA3-0' + self.extensaoPagina + '">Monografia de conclusão de curso de aperfeiçoamento/especialização</a> ' + '(' + str(self.nOA3) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOA3) + ')'
            if self.nOA4 > 0:
                s += '<li> <a href="OA4-0' + self.extensaoPagina + '">Trabalho de conclusão de curso de graduação</a> ' + '(' + str(self.nOA4) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOA4) + ')'
            if self.nOA5 > 0:
                s += '<li> <a href="OA5-0' + self.extensaoPagina + '">Iniciação científica</a> ' + '(' + str(self.nOA5) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOA5) + ')'
            if self.nOA6 > 0:
                s += '<li> <a href="OA6-0' + self.extensaoPagina + '">Orientações de outra natureza</a> ' + '(' + str(self.nOA6) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOA6) + ')'
            if self.nOA > 0:
                s += '<li> <a href="OA-0' + self.extensaoPagina + '">Total de orientações em andamento</a> ' + '(' + str(self.nOA) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOA) + ')'
            else:
                s += '<i>Nenhum item achado nos currículos Lattes</i>'#.decode("utf8")
            s += '</ul>'
            ...
            s += '<ul>'
            if self.nOC0 > 0:
                s += '<li> <a href="OC0-0' + self.extensaoPagina + '">Supervisão de pós-doutorado</a> ' + '(' + str(self.nOC0) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOC0) + ')'
            if self.nOC1 > 0:
                s += '<li> <a href="OC1-0' + self.extensaoPagina + '">Tese de doutorado</a> ' + '(' + str(self.nOC1) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOC1) + ')'
            if self.nOC2 > 0:
                s += '<li> <a href="OC2-0' + self.extensaoPagina + '">Dissertação de mestrado</a> '+ '(' + str(self.nOC2) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOC2) + ')'
            if self.nOC3 > 0:
                s += '<li> <a href="OC3-0' + self.extensaoPagina + '">Monografia de conclusão de curso de aperfeiçoamento/especialização</a> '+ '(' + str(self.nOC3) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOC3) + ')'
            if self.nOC4 > 0:
                s += '<li> <a href="OC4-0' + self.extensaoPagina + '">Trabalho de conclusão de curso de graduação</a> ' + '(' + str(self.nOC4) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOC4) + ')'
            if self.nOC5 > 0:
                s += '<li> <a href="OC5-0' + self.extensaoPagina + '">Iniciação científica</a> '+ '(' + str(self.nOC5) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOC5) + ')'
            if self.nOC6 > 0:
                s += '<li> <a href="OC6-0' + self.extensaoPagina + '">Orientações de outra natureza</a> ' + '(' + str(self.nOC6) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOC6) + ')'
            if self.nOC > 0:
                s += '<li> <a href="OC-0' + self.extensaoPagina + '">Total de orientações concluídas</a> '+ '(' + str(self.nOC) + ')'#.decode(
                    #"utf8") + '(' + str(self.nOC) + ')'
            else:
                s += '<i>Nenhum item achado nos currículos Lattes</i>'#.decode("utf8")
            s += '</ul>'
        ...
        if self.grupo.obterParametro('relatorio-incluir_projeto'):
            ...
            if self.nPj > 0:
                s += '<li> <a href="Pj-0' + self.extensaoPagina + '">Total de projetos de pesquisa</a> ' + '(' + str(self.nPj) + ')'#.decode(
                    #"utf8") + '(' + str(self.nPj) + ')'
            else:
                s += '<i>Nenhum item achado nos currículos Lattes</i>'#.decode("utf8")
            s += '</ul>'
        ...
        if self.grupo.obterParametro('relatorio-incluir_premio'):
            ...
            if self.nPm > 0:
                s += '<li> <a href="Pm-0' + self.extensaoPagina + '">Total de prêmios e títulos</a> ' + '(' + str(self.nPm) + ')'#.decode(
                    #"utf8") + '(' + str(self.nPm) + ')'
            else:
                s += '<i>Nenhum item achado nos currículos Lattes</i>'#.decode("utf8")
            s += '</ul>'
        ...
        if self.grupo.obterParametro('relatorio-incluir_participacao_em_evento'):
            ...
            if self.nEp > 0:
                s += '<li> <a href="Ep-0' + self.extensaoPagina + '">Total de participação em eventos</a> '+ '(' + str(self.nEp) + ')'#.decode(
                    #"utf8") + '(' + str(self.nEp) + ')'
            else:
                s += '<i>Nenhum item achado nos currículos Lattes</i>'#.decode("utf8")
            s += '</ul>'
        ...
        if self.grupo.obterParametro('relatorio-incluir_organizacao_de_evento'):
            ...
            if self.nEo > 0:
                s += '<li> <a href="Eo-0' + self.extensaoPagina + '">Total de organização de eventos</a> ' + '(' + str(self.nEo) + ')'#.decode(
                    #"utf8") + '(' + str(self.nEo) + ')'
            else:
                s += '<i>Nenhum item achado nos currículos Lattes</i>'#.decode("utf8")
            s += '</ul>'
        ...
        if self.grupo.obterParametro('relatorio-incluir_internacionalizacao'):
            ...
            if self.nIn0 > 0:
                s += '<li> <a href="In0-0' + self.extensaoPagina + '">Coautoria e internacionalização</a> ' + '(' + str(self.nIn0) + ')'#.decode(
                    #"utf8") + '(' + str(self.nIn0) + ')'
            else:
    ...
    def gerar_pagina_de_metricas(self):
        ...
        for membro in self.grupo.listaDeMembros:
            ...
            bolsa = membro.bolsaProdutividade if membro.bolsaProdutividade else ''
            rotulo = membro.rotulo if not membro.rotulo == '[Sem rotulo]' else ''
            #TODO verify the replace and ignore case
            #rotulo = rotulo.decode('iso-8859-1', 'replace')
            #nomeCompleto = unicodedata.normalize('NFKD', membro.nomeCompleto).encode('ASCII', 'ignore')
            rotulo = rotulo
            nomeCompleto = unicodedata.normalize('NFKD', membro.nomeCompleto)
    ...
    def paginaBottom(self):
        ...
        Os resultados estão sujeitos a falhas devido a inconsistências no preenchimento dos CVs Lattes. E-mail de contato: <a href="mailto:' + self.grupo.obterParametro('global-email_do_admin') + '">' + self.grupo.obterParametro('global-email_do_admin') + '</a> \
        </div> '
